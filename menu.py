...
def create_char():
    ...
    if os.path.exists(char_dir+"/"+user_name+".txt") == True:
    ...
    for x1 in wlist:
        print wmenu,".){:^5}      {:1}.) {:10}".format(plist[pro_ch][wc],wmenu,x1)
        wc+=1
        wmenu+=1
    print
    ...
    for outer_list in skill_list:
        ...
        char[s]=(outer_list[1],outer_list[5],outer_list[index],outer_list[6])
        crt+=1
